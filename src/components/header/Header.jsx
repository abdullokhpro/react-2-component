...
import { HEADER_LIST } from "../../static/listData";

function Header() {
  let navList = HEADER_LIST?.map((val, inx) => {
    return (
        ...
        <div className="container header__container">
            ...
            <div className="logo">
              <a className="header__logo" href="#">
                <svg
                  ...
                  aria-hidden="true"
                  tabIndex="-1"
                  data-di-res-id="2d99159a-ebe51957"
                  data-di-rand="1714990751713"
                >
                  <rect
                    id="Clear_space"
                    width="120"
          ...
          <div className="header__right">
            ...
            <div className="header__buttons">
              <CiSearch className="header__buttons__btn" />
              <CiShoppingCart className="header__buttons__btn" />
              <CiUser className="header__buttons__btn" />
            </div>
          </div>
        </div>
      </nav>
